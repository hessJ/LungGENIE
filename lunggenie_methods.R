...
fit_lr_weights_in_gtex = function(pca_model  = NULL,  gene_list = NULL, n_comps = 20){
...
retrain_gtex = function(gene_list = NULL, output = "", set_seed = T, seed = 123, ncomps = 20, prop_for_test_set = 0.1, n_folds = 5){
  ...
  output_file_string <<- paste(output, "/LungGENIE_retrain-", ncomps, ".Rdata", sep="")
  ...
  saveRDS(all.models.merge, file=paste(output, "/LungGENIE_retrain-",ncomps,".Rdata", sep=""))
